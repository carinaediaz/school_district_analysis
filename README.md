...
##### Thomas High School has 1,635 students, falling into the medium school size category, therefore we will only see changes in the passing percentages for the medium high school category. 
...
## Summary
##### While the changes on the district level summaries may be nominal, when we magnify our analysis on Thomas High School's individual results, we note drastic changes. Most notably, Thomas High School went from being the 2nd top performing high school to the 8th. Thomas High School's overall passing percentage dropped over 25%, from 90.9% to 65.7%. Separately, the passing math percentage dropped over 26%, from 93.3% to 66.9%, and the passing reading percentage dropped 27%, from 97.3% to 69.7%. District wide, the changes can only be seen in the tenths place. 
